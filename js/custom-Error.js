// Define los tipos de errores de validación que se utilizarán en la aplicación.
...
// Contiene los mensajes de error personalizados para cada campo de entrada,
// categorizados por el tipo de error de validación.
